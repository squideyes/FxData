...
//public readonly struct Tick(TickOn tickOn, Rate bid, Rate ask) 
//    : IEquatable<Tick>
//{
//    public TickOn TickOn { get; } = tickOn.MayNotBe().Default();
//    public Rate Bid { get; } = bid.MayNotBe().Default();
//    public Rate Ask { get; } = ask.MustBe().True(v => !v.IsDefault() && ask > bid);
